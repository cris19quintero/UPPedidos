// ===== controllers/orderController.js - CORREGIDO PARA PRODUCTOS =====
...
const createOrderFromCart = async (req, res) => {
    try {
        ...
        await runTransaction(async (transaction) => {
            ...
            // 🔥 CAMBIO: Verificar PRODUCTOS y calcular total
            const items = [];
            let total = 0;
            ...
            for (const itemDoc of itemsSnapshot.docs) {
                ...
                const itemData = {
                    id_producto: item.id_producto, // 🔥 CAMBIO: usar id_producto
            ...
            // 🔥 CAMBIO: Actualizar estadísticas del PRODUCTO
            items.forEach(item => {
                const productoRef = db.collection('productos').doc(item.id_producto);
